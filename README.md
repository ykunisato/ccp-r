...
3. If you use a Julia, please execute the following code on Terminal in the Rstudio.
...
Unfortunately, the Julia packages cannot be installed by general users. 
